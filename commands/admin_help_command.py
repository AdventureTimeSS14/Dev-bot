...
ADMIN_COMMANDS = [
    ...
    {
        "name": "🔓 &pardon <ban_id> [<AdminName>](Если хотите указать что разбанили именно вы, введите свой никнейм)",
        "description": "Разбанивает пользователя по id его серверного бана.(не путать с разбаном для ролей). По умолчанию разбанивает с общего админского технического аккаунта, если не указан второй аргумент.",
    },
    {
    ...
    },
    {
        ...
        "description": "Добавляет указанное количество времени игроку для определённой должности. Укажите никнейм игрока, идентификатор должности (ProtoIdJob) и количество времени (в минутах). ‼️ Минуты можно ввести отрицательные, тогда время будет убавлено!!",
    },
    {
