...
button_help = Button(
    ...
    custom_id="button_help_id"
)

button_team_help = Button(
    label="&team_help",
    style=ButtonStyle.blurple,
    custom_id="button_team_help_id"
)

button_git_help = Button(
    label="&git_help",
    style=ButtonStyle.gray,
    custom_id="button_git_help_id"
)

button_admin_help = Button(
    label="&admin_help",
    style=ButtonStyle.red,
    custom_id="button_admin_help_id"
)
